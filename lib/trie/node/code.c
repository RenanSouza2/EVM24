...
evm_rlp_t rlp_init_node_leaf(evm_node_leaf_p n) // TODO test
{
...
evm_rlp_t rlp_init_node_branch(evm_node_branch_p n) // TODO test
{
...
evm_rlp_t rlp_init_node_extension(evm_node_extension_p n) // TODO test
{
    evm_rlp_vec_t r_vec = rlp_vec_init(2);
    r_vec.arr[0] = rlp_init_byte_vec(n->path);
